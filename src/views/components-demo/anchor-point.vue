<template>
  <div class="sphere_container">
    <div class="floor floor_one">
      <div style="font-size: 20px;text-align: center;padding: 200px">锚点测试</div>
    </div>
    ...
    <div class="right_anchor">
      <ul>
        <li :class="steps ===0 ? 'dot': 'dot dot1'" @click="anchors(1)" />
        <!--        <li :class="steps == 1?'lines':'no_line'" />-->
        <li :class="steps ===1 ? 'dot': 'dot dot1'" @click="anchors(2)" />
        <!--        <li :class="steps == 2?'lines':'no_line'" />-->
        <li :class="steps ===2 ? 'dot': 'dot dot1'" @click="anchors(3)" />
        <!--        <li :class="steps == 3?'lines':'no_line'" />-->
        <li :class="steps ===3 ? 'dot': 'dot dot1'" @click="anchors(4)" />
        <!--        <li :class="steps == 4?'lines':'no_line'" />-->
        <li :class="steps ===4 ? 'dot': 'dot dot1'" @click="anchors(5)" />
      </ul>
    </div>
  </div>
</template>
